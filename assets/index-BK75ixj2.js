/**
 * Autodrills Preview Asset: index-BK75ixj2.js
 * 
 * Runs: Browser-side on the public sample site.
 * Responsibility: Part of the bundled preview application.
 */
const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./App-2zPLrKfO.js","./_plugin-vue_export-helper-mPWG5G5X.js","./runtime-core.esm-bundler-C21_olk_.js","./indexedDbClient-BhXpRefM.js","./App-Cqw4cbS5.css","./router-DSIBkR0r.js","./runtime-dom.esm-bundler-BMkBX2kS.js","./substitutions-DfevYuFc.js","./drillSelection-BI-qkrnO.js","./router-CgkHdVsl.css"])))=>i.map(i=>d[i]);
...
if (!globalThis.drillSelection) {
  globalThis.drillSelection = __CJS__export_default__ || drillSelectionModule;
}
const [{ default: App }, { default: router }] = await Promise.all([
  __vitePreload(() => import("./App-2zPLrKfO.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0, import.meta.url),
  __vitePreload(() => import("./router-DSIBkR0r.js"), true ? __vite__mapDeps([5,1,2,3,6,7,8,9]) : void 0, import.meta.url)
]);
createApp(App).use(router).mount("#app");
//# sourceMappingURL=index-BK75ixj2.js.map
