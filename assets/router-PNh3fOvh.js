/**
 * Autodrills Preview Asset: router-PNh3fOvh.js
 * 
 * Runs: Browser-side on the public sample site.
 * Responsibility: Part of the bundled preview application.
 */
import { _ as _export_sfc, c as apiClient, u as useAppBootstrap, d as createRouter, e as createWebHashHistory } from "./_plugin-vue_export-helper-D-TdMnaI.js";
...
import { _ as __CJS__export_default__$6, s as substitutionsModule$1, a as __CJS__export_default__$7, b as attemptContextModule } from "./substitutions-BboDPcLC.js";
import { _ as __CJS__export_default__$8, d as drillSelectionModule } from "./drillSelection-Zqn8DlrJ.js";
...
function usePracticeSession() {
  ...
  async function fetchSessionSlice(force = false) {
    ...
    try {
      const response = await apiClient.fetchPracticeSessionSlice({
        ...
        targetSessionLength: targetSessionLength.value,
  ...
  async function nextDrill() {
    ...
    if (currentSessionAttemptOrdinal.value >= targetSessionLength.value) {
      sessionComplete.value = true;
      return;
    }
    cancelAutoAdvance();
                ...
                !focusMode.value ? (openBlock(), createElementBlock("div", _hoisted_25$1, [
                  createBaseVNode("div", _hoisted_26$1, [
                    createVNode(PracticeToolbar, {
                      ...
                      "can-go-next-drill": unref(session).isReviewMode.value ? unref(session).hasNextReviewedDrill.value : Boolean(unref(session).viewFeedback.value) && !unref(session).sessionComplete.value,
                      onSubmit: unref(session).submitAnswer,
                ...
                focusMode.value ? (openBlock(), createElementBlock("div", _hoisted_27$1, [
                  ...
                  createBaseVNode("div", _hoisted_32, [
                    ...
                    createBaseVNode("button", {
                      ...
                      disabled: unref(session).isReviewMode.value ? !unref(session).hasNextReviewedDrill.value : !unref(session).viewFeedback.value || unref(session).sessionComplete.value,
...
const PracticePage = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-68e9b546"]]);
...
const totalSkills$1 = 39;
const totalDrills$1 = 117;
...
const practiceDepthRange = "10-25";
const _sfc_main = {
  __name: "UpgradePage",
  setup(__props) {
    ...
    const comparisonRows = [
      ...
      },
      {
        ...
        preview: 3,
        full: practiceDepthRange,
        note: "Curated drills per selected skill in preview versus deeper full-library practice"
      },
      {
        label: "Skills",
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
                    ...
                    return createBaseVNode("div", {
                      ...
                      createBaseVNode("div", _hoisted_16, [
                        ...
                        createBaseVNode("div", _hoisted_18, [
                          createBaseVNode("div", _hoisted_19, toDisplayString(formatMetric(row.preview)), 1),
                          _cache[6] || (_cache[6] = createBaseVNode("div", { class: "text-muted small mb-1" }, "preview", -1))
                        ]),
                        createBaseVNode("div", _hoisted_20, [
                          createBaseVNode("div", _hoisted_21, toDisplayString(formatMetric(row.full)), 1),
          ...
          createBaseVNode("div", _hoisted_23, [
            ...
            _cache[10] || (_cache[10] = createStaticVNode('<section class="card panel-card shadow-sm border-0 mb-4" data-v-c38107b1><div class="card-body p-4" data-v-c38107b1><h2 class="h5 fw-bold mb-3" data-v-c38107b1>What to request from Orion Smith</h2><ul class="small text-muted ps-3 mb-3" data-v-c38107b1><li data-v-c38107b1>Connect the classroom full version.</li><li data-v-c38107b1>Confirm the public preview screenshots are safe to ship.</li><li data-v-c38107b1>Review any setup or identity questions before publishing the full site.</li></ul><a href="#setup-workbook-coming-soon" class="btn btn-outline-primary btn-sm" data-v-c38107b1>Copyable setup workbook coming soon</a><div class="small text-muted mt-2" data-v-c38107b1> The full version stays free, but it does require setup and a classroom copy of the Google Sheets workbook. </div></div></section>', 1))
          ])
        ])
      ]);
    };
...
const UpgradePage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c38107b1"]]);
...
//# sourceMappingURL=router-PNh3fOvh.js.map
